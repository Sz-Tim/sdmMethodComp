...
sp_i <- list(p=list(s_z=c(-8, 2.1, -.09), # b1 + b2*z + b3*z^2
                    ...
                    NDD_n=mean_abund/2, # mean number of recruits if NDD
...
```{r O_setup}
O_n <- list(Mx=500, CA=20, IPM=10) # number of cells in sample
...
lam.df %<>% 
  add_column(lam.S.f=S.f$N_sim[,tmax]/(S.f$N_sim[,tmax-1]+.01),
             nSeed.f=S.f$nSd[,tmax], D.f=S.f$D[,tmax], 
...
ggplot(lam.df, aes(x=lon, y=lat)) + 
  geom_tile(aes(fill=lambda.f-lambda, colour=id.inbd %in% IPM.P)) +
  scale_colour_manual(values=c(NA, "black")) +
  scale_fill_gradient2(low="darkblue", mid="white", high="darkred", midpoint=0)
ggplot(lam.df, aes(x=lon, y=lat)) + 
  geom_tile(aes(fill=lam.S.f-lam.S, colour=id.inbd %in% IPM.P)) +
  scale_colour_manual(values=c(NA, "black")) +
  scale_fill_gradient2(low="darkblue", mid="white", high="darkred", midpoint=0)
ggplot(lam.df, aes(x=lon, y=lat)) + 
  geom_tile(aes(fill=lam.U.f-lam.U, colour=id.inbd %in% IPM.P)) +
  scale_colour_manual(values=c(NA, "black")) +
  scale_fill_gradient2(low="darkblue", mid="white", high="darkred", midpoint=0)
ggplot(lam.df, aes(x=lon, y=lat)) + 
  geom_tile(aes(fill=lam.S>1, colour=id.inbd %in% IPM.P)) +
  scale_colour_manual(values=c(NA, "black"))
ggplot(lam.df, aes(x=lon, y=lat)) + 
  geom_tile(aes(fill=lam.S.f>1, colour=id.inbd %in% IPM.P)) +
  scale_colour_manual(values=c(NA, "black"))
ggplot(lam.df, aes(x=lon, y=lat)) + 
  geom_tile(aes(fill=(lambda>1 & lambda.f>1) | (lambda<1 & lambda.f<1),
                colour=id.inbd %in% IPM.P)) +
  scale_colour_manual(values=c(NA, "black"))
ggplot(lam.df, aes(x=lon, y=lat)) + 
...
ggplot(lam.df, aes(x=lon, y=lat)) + 
  ...
  scale_colour_manual(values=c(NA, "black"))
ggplot(lam.df, aes(x=lon, y=lat)) + 
  geom_tile(aes(fill=(N.S.f-N.S)/N.S, colour=id.inbd %in% IPM.P)) +
  scale_colour_manual(values=c(NA, "black")) +
  scale_fill_gradient2(low="darkblue", mid="white", high="darkred", midpoint=0)
ggplot(lam.df, aes(x=lon, y=lat)) + 
  geom_tile(aes( fill=(Surv.S.f-Surv.S)/Surv.S, colour=id.inbd %in% IPM.P)) +
  scale_colour_manual(values=c(NA, "black")) +
  scale_fill_gradient2(low="darkblue", mid="white", high="darkred", midpoint=0)
ggplot(lam.df, aes(x=lon, y=lat)) + 
  geom_tile(aes(fill=(Rcr.S.f-Rcr.S)/Rcr.S, colour=id.inbd %in% IPM.P)) +
  scale_colour_manual(values=c(NA, "black")) +
  scale_fill_gradient2(low="darkblue", mid="white", high="darkred", midpoint=0)
par(mfrow=c(2,2))
