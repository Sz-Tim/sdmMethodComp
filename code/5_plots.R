...
if(plots) ggsave(paste0("figs/", sp, "_TSS.jpg"), width=6, height=8)
ggplot(out_TSS, aes(x=sensitivity, fill=SDM, colour=SDM)) + 
  ...
  theme(panel.grid=element_blank())
if(plots) ggsave(paste0("figs/", sp, "_Sensitivity.jpg"), width=6, height=8)
ggplot(out_TSS, aes(x=specificity, fill=SDM, colour=SDM)) + 
  ...
  theme(panel.grid=element_blank())
if(plots) ggsave(paste0("figs/", sp, "_Specificity.jpg"), width=6, height=8)
...
if(plots) ggsave(paste0("figs/", sp, "_S_lambda.jpg"), width=9, height=8)
ggplot() + geom_tile(data=lam.df, aes(lon, lat), fill="gray30") +
...
if(plots) ggsave(paste0("figs/", sp, "_S_N_Eq.jpg"), width=9, height=8)
ggplot() + geom_tile(data=lam.df, aes(lon, lat), fill="gray30") +
...
if(plots) ggsave(paste0("figs/", sp, "_S_N_nonEq.jpg"), width=9, height=8)
...
if(plots) ggsave(paste0("figs/", sp, "_pr50_barplot_lambda.jpg"), width=7, height=8)
...
if(plots) ggsave(paste0("figs/", sp, "_pr50_barplot_N.jpg"), width=7, height=8)
...
if(plots) ggsave(paste0("figs/", sp, "_pr50_map_lambda.jpg"), width=12, height=7)
ggplot(out_P, aes(x=lon, y=lat, fill=fate_S)) +
  geom_tile() + facet_grid(SDM~issue) + 
  scale_fill_brewer(name="Boundary:\nN > 0", type="div") +
  theme(axis.text=element_blank()) + ggtitle(sp)
if(plots) ggsave(paste0("figs/", sp, "_pr50_map_N.jpg"), width=12, height=7)
...
ggplot(out_P, aes(x=lon, y=lat, fill=prP)) +
  ...
  theme(axis.text=element_blank()) + ggtitle(sp)
if(plots) ggsave(paste0("figs/", sp, "_prP_map.jpg"), width=12, height=7)
...
if(plots) ggsave(paste0("figs/", sp, "_P_map_lambda.jpg"), width=12, height=2.5)
...
ggplot() + geom_tile(data=filter(out_P, grepl("CA", SDM)), 
  ...
  theme(axis.text=element_blank())
if(plots) ggsave(paste0("figs/", sp, "_P_map_Rcr.jpg"), width=12, height=4)
ggplot() + geom_tile(data=filter(out_P, grepl("CA", SDM)), 
                     aes(x=lon, y=lat), fill="gray30") +
  ...
  theme(axis.text=element_blank())
if(plots) ggsave(paste0("figs/", sp, "_P_map_B.jpg"), width=12, height=4)
ggplot() +
  ...
  theme(axis.text=element_blank())
if(plots) ggsave(paste0("figs/", sp, "_P_map_D.jpg"), width=12, height=4)
ggplot() +
  geom_tile(data=filter(out_P, grepl("CA", SDM)), 
            aes(x=lon, y=lat), fill="gray30") +
  ...
  theme(axis.text=element_blank())
if(plots) ggsave(paste0("figs/", sp, "_P_map_nSeed.jpg"), width=12, height=4)
ggplot() +
  geom_tile(data=filter(out_P, grepl("CA", SDM)), 
            aes(x=lon, y=lat), fill="gray30") +
  ...
  theme(axis.text=element_blank())
if(plots) ggsave(paste0("figs/", sp, "_P_map_nSeedLocal.jpg"), width=12, height=4)
ggplot() +
  geom_tile(data=filter(out_P, grepl("CA", SDM)), 
            aes(x=lon, y=lat), fill="gray30") +
  ...
  theme(axis.text=element_blank())
if(plots) ggsave(paste0("figs/", sp, "_P_map_propagule.jpg"), width=12, height=4)
...
if(plots) ggsave(paste0("figs/", sp, "_scatter_prP_lambda.jpg"), width=12, height=7)
...
if(plots) ggsave(paste0("figs/", sp, "_scatter_N.jpg"), width=12, height=4)
...
if(plots) ggsave(paste0("figs/", sp, "_scatter_lambda.jpg"), width=12, height=2.5)
